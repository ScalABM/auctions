...
/** Mth highest price determines the fill price.
  ...
  * @since 0.1.0
  */
class AskQuotePricingPolicy[T <: Tradable] extends SingleUnitPricingPolicy[T] {
...
object AskQuotePricingPolicy {

  def apply[T <: Tradable](): AskQuotePricingPolicy[T] = {
    new AskQuotePricingPolicy[T]()
  }
