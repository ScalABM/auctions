...
object FourHeapOrderBook {
  ...
  def empty[T <: Tradable]: FourHeapOrderBook[T] = {
    val matchedOrders = MatchedOrders.empty[T](SingleUnitOrder.ordering.reverse, SingleUnitOrder.ordering)
    val unMatchedOrders = UnMatchedOrders.empty[T](SingleUnitOrder.ordering, SingleUnitOrder.ordering.reverse)
