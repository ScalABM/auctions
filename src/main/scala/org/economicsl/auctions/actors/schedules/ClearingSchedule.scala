...
sealed trait ClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
...
trait BidderActivityClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
...
trait BidderInActivityClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
    extends ClearingSchedule[T, A] {
  this: AuctionActor[T, A] =>
...
trait OnDemandClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
    extends ClearingSchedule[T, A] {
  this: AuctionActor[T, A] =>
...
trait PeriodicClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
    extends ClearingSchedule[T, A] {
  this: AuctionActor[T, A] =>
...
trait RandomClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
...
/** Mixin trait for scheduling order issuing via a Poisson process.
  ...
  * @since 0.2.0
  */
trait PoissonClearingSchedule[T <: Tradable, A <: SingleUnitAuction[T, A]]
