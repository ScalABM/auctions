...
class MatchedOrdersSpec extends FlatSpec with Matchers {
  ...
  "A set of MatchedOrders" should " accept a " in {
    ...
    val empty = MatchedOrders.empty[GoogleStock](orders.LimitAskOrder.ordering.reverse, orders.LimitBidOrder.ordering.reverse)
  ...
  "A set of MatchedOrders" should " accept a sdasdf " in {
    ...
    val issuer2 = UUID.randomUUID()
    val order2 = orders.LimitBidOrder(issuer2, Price(15), Quantity(10), google)
  ...
  "A set of MatchedOrders" should " accept a fdgdfg " in {
    ...
    val issuer2 = UUID.randomUUID()
    val order2 = orders.LimitBidOrder(issuer2, Price(15), Quantity(100), google)
